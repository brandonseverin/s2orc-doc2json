...
from s2orc_doc2json.doc2json.jats2json.jats_to_json import (
    convert_jats_xml_to_s2orc_json,
)
...
def process_jats_stream(fname: str, stream: bytes, temp_dir: str = BASE_TEMP_DIR):
    """
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-i", "--input", default=None, help="path to the input JATS XML file"
    )
    parser.add_argument(
        "-o",
        "--output",
